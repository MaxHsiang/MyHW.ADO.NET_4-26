...
namespace MyHW.MyDataSetTableAdapters {
...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "SELECT *\r\nFROM Products\r\nwhere UnitPrice between @start and @end";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@start", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@end", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByName(MyDataSet.ProductsDataTable dataTable, string name) {
        ...
        public virtual MyDataSet.ProductsDataTable GetDataByName(string name) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByUnitPrice(MyDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> start, global::System.Nullable<decimal> end) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((start.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(start.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual MyDataSet.ProductsDataTable GetDataByUnitPrice(global::System.Nullable<decimal> start, global::System.Nullable<decimal> end) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((start.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(start.Value));
            }
